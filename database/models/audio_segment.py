...
class AudioSegment(Base):
    ...
    radio_file: Mapped["RadioFile"] = relationship("RadioFile", back_populates="audio_segments", lazy="selectin" )
    detections: Mapped[list["Detection"]] = relationship("Detection", back_populates="audio_segment", lazy="selectin")
